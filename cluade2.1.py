...
from PyQt5.QtGui import QIcon, QBrush, QColor, QFont, QPen, QPixmap, QDrag, QCursor, QPainter, QPainterPath, QTransform
...
class GraphicsStateItem(QGraphicsRectItem):
    ...
    def paint(self, painter, option, widget):
        ...
        if self.is_initial:
            ...
            painter.drawEllipse(int(self.rect().left() - 15), int(self.rect().center().y() - 5), 10, 10)
