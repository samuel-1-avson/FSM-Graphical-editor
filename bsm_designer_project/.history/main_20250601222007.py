...
class MainWindow(QMainWindow):
    ...
    def _create_toolbars(self):
        ...
        try:
            ...
            edit_toolbar.addAction(self.add_state_mode_action)
            edit_toolbar.addAction(self.add_transition_mode_action)
            edit_toolbar.addAction(self.add_comment_mode_action)
