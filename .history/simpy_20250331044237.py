...
def main():
    ...
    # Add state actions
    def start_action():
        print("Executing start actions...")
        
    sm.add_state_action('idle', start_action)
    sm.add_state_action('moving', lambda: print("Moving..."))
    sm.add_state_action('stopped', lambda: print("Stopping..."))
