...
class BrainSimulatorGUI(QMainWindow):
    ...
    def createDockWidgets(self):
        ...
        memoryTable.setItem(0, 0, QTableWidgetItem("Output"))
        memoryTable.setItem(0, 1, QTableWidgetItem("3"))
        memoryTable.setItem(0, 2, QTableWidgetItem("Single"))
        memoryTable.setItem(1, 0, QTableWidgetItem("RandomNumber"))
        memoryTable.setItem(1, 1, QTableWidgetItem("4"))
        memoryTable.setItem(1, 2, QTableWidgetItem("Single"))
...
Paused."""
        ...
        # Add row data
        infoTable.setItem(0, 0, QTableWidgetItem("NKmeansWM00"))
        infoTable.setItem(0, 1, QTableWidgetItem("Node will load data from user defined folder: C:\\projects\\BrainSimulatorSampleProjects\\"))
        infoTable.setItem(1, 0, QTableWidgetItem("Hid1"))
        infoTable.setItem(1, 1, QTableWidgetItem("Node will load data from user defined folder: C:\\projects\\BrainSimulatorSampleProjects\\"))
        infoTable.setItem(2, 0, QTableWidgetItem("Hid2"))
        infoTable.setItem(2, 1, QTableWidgetItem("Node will load data from user defined folder: C:\\projects\\BrainSimulatorSampleProjects\\"))
