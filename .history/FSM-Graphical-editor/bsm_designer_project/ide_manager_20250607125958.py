...
from PyQt5.QtWidgets import (
    ...
    QTextEdit, QFileDialog, QMessageBox, QInputDialog, QStyle,QHBoxLayout
)
from PyQt5.QtCore import QObject, pyqtSlot, QSize, QTime, QDir, Qt # Added Qt here
...
class IDEManager(QObject):
    ...
    def _setup_ide_dock_widget_content(self):
        ...
        ide_toolbar.setToolButtonStyle(Qt.ToolButtonIconOnly) # This line caused the error
