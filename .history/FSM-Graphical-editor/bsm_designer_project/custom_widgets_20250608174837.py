...
class DraggableToolButton(QPushButton): 
    ...
    def mouseMoveEvent(self, event: QMouseEvent):
        ...
        # Using self.renderFlags() is generally safer if default flags are okay
        # or construct RenderFlags explicitly if specific behavior is needed.
        # The original code's QWidget.RenderFlags(...) might work due to integer conversion,
        # but this is cleaner.
        self.render(pixmap, QPoint(), QRegion(), self.renderFlags())
