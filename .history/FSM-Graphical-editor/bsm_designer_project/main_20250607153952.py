...
from snippet_manager import CustomSnippetManager # Add this import
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.custom_snippet_manager = CustomSnippetManager(app_name=APP_NAME) # Instantiate the manager
    ...
    def _update_window_title(self):
        ...
        main_op_text = f"File: {file_name_part}{diagram_dirty_char}" 
        ...
        elif not self.current_file_path and not self.scene.is_dirty(): 
            main_op_text = "Ready"
