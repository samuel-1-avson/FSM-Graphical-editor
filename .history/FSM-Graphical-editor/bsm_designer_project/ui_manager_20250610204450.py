...
from .custom_widgets import DraggableToolButton # Corrected import
...
class UIManager(QObject): 
    ...
    def _safe_get_style_enum(self, attr_name, fallback_attr_name=None): # Moved here
    ...
    def _create_actions(self):
        ...
        mw.export_python_fsm_action = QAction(get_standard_icon(QStyle.SP_DialogSaveButton, "PyGen"), "Export to &Python FSM Class...", mw) # ADDED
    ...
    def _create_menus(self):
        ...
        export_menu.addAction(mw.export_python_fsm_action) # ADDED
        export_menu.addSeparator()
    ...
    def _create_toolbars(self):
        ...
        export_menu_tb.addAction(mw.export_python_fsm_action) # ADDED
    ...
    def _create_status_bar(self):
        ...
        # --- Interaction Mode Status Segment ---
        mode_segment, mw.mode_icon_label, mw.mode_status_label = self._create_status_bar_segment(
            QStyle.SP_ArrowRight, "ModeSel", "Select", "Current Interaction Mode", "InteractionModeStatusLabel", 70) # Initial text "Select"
        ...
        zoom_segment, mw.zoom_icon_label, mw.zoom_status_label = self._create_status_bar_segment(
            QStyle.SP_FileDialogContentsView, "Zoom", "100%", "Current Zoom Level", "ZoomStatusLabel", 50) # Text part reduced
        mw.zoom_icon_label.setToolTip("Current Zoom Level") # Specific tooltip for icon part
        mw.zoom_status_label.setMinimumWidth(35) # Adjusted for just "100%"
        ...
        resource_layout.setContentsMargins(0,0,0,0); resource_layout.setSpacing(1) # Very compact
