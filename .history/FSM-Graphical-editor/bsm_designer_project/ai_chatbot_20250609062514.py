...
from PyQt5.QtGui import QMovie, QIcon, QColor, QDesktopServices # Added QDesktopServices here
...
class AIChatUIManager(QObject):
    ...
    def create_dock_widget_contents(self) -> QWidget:
        ...
        # Key flags for link interaction:
        self.ai_chat_display.setTextInteractionFlags(Qt.LinksAccessibleByMouse | Qt.TextSelectableByKeyboard)
        # Qt.TextBrowserInteraction implies Qt.LinksAccessibleByMouse, Qt.TextSelectableByMouse,
        # Qt.TextSelectableByKeyboard, and potentially others.
        # Using more specific flags if TextBrowserInteraction is too broad or causes issues.
        # self.ai_chat_display.setTextInteractionFlags(Qt.TextBrowserInteraction) # Alternative
    ...
    def on_chat_anchor_clicked(self, url: QUrl):
        if url.scheme() == 'copycode':
            ...
            # This is where you'd handle other schemes, like 'http' or 'https'
