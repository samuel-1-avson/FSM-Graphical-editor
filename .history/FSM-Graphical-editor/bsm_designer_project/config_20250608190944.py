...
FSM_TEMPLATES_BUILTIN_JSON_STR = """
{
    "DebounceLogic": {
        ...
        "states": [
            {"name": "Unstable", "x": 50, "y": 50, "description": "Input is currently unstable or bouncing."},
            {"name": "Waiting", "x": 250, "y": 50, "entry_action": "start_debounce_timer()"},
            {"name": "Stable", "x": 450, "y": 50, "description": "Input is considered stable."}
        ],
        "transitions": [
        ...
        "comments": [
            {"text": "Debounce timer should be set appropriately.", "x": 250, "y": 150, "width": 180}
        ]
    },
    "Blinker": {
        "name": "Simple Blinker",
        ...
        "states": [
            {"name": "LedOff", "is_initial": true, "x": 50, "y": 50, "entry_action": "set_led_off()\\nstart_timer(OFF_DURATION)"},
            {"name": "LedOn", "x": 250, "y": 50, "entry_action": "set_led_on()\\nstart_timer(ON_DURATION)"}
        ],
        "transitions": [
        ...
        "comments": [
            {"text": "Define ON_DURATION and OFF_DURATION variables.", "x": 50, "y": 150, "width": 200}
        ]
    }
}
"""
...
def GET_CURRENT_STYLE_SHEET():
    ...
    QDockWidget QWidget {{ /* Ensure widgets inside docks also get base text color */
        ...
        background-color: {COLOR_BACKGROUND_APP}; /* Ensure dock widgets have themed background */
    }}
    ...
    QToolButton:hover, QDockWidget#ElementsPaletteDock QToolButton:hover {{ /* Changed ToolsDock to ElementsPaletteDock */
    ...
    QDialog QLabel, QDialog QCheckBox, QDialog QRadioButton, QDialog QSpinBox, QDialog QDoubleSpinBox, QDialog QFontComboBox {{ /* Ensure text in dialogs gets themed color */
        color: {COLOR_TEXT_PRIMARY};
    }}
    ...
    QDockWidget#ElementsPaletteDock QToolButton {{ /* Specific for main toolbar buttons if needed, or general QToolButton applies */
        padding: 6px 8px; text-align: left; 
        min-height: 34px; 
        font-weight: 500;
    }}
    QDockWidget#ElementsPaletteDock QGroupBox {{ /* Ensure groupbox titles in palette are themed */
        color: {COLOR_TEXT_PRIMARY};
    }}
    QDockWidget#ElementsPaletteDock QGroupBox::title {{
        color: {COLOR_ACCENT_PRIMARY};
        background-color: {COLOR_BACKGROUND_APP}; /* Match palette background */
    }}
