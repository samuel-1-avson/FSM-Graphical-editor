...
class UIManager(QObject): 
    ...
    def _create_menus(self):
        ...
        mw.docks_menu = mw.view_menu.addMenu("Docks & Panels") # Changed for clarity
        mw.view_menu.addSeparator()
        mw.perspectives_menu = mw.view_menu.addMenu("Perspectives")
        mw.perspectives_action_group = QActionGroup(mw) # For checkable perspective actions
        mw.perspectives_menu.addSeparator() # Separator before save/reset actions
        ...
        logger.debug("UIManager: Menus created, Perspectives menu added to View.")
    ...
    def _create_docks(self):
        ...
        mw.addDockWidget(Qt.BottomDockWidgetArea, mw.log_dock); # Visibility managed by perspectives
        ...
        mw.problems_dock.setVisible(False) # Default hidden, shown by perspectives or when issues arise
        ...
        if hasattr(mw, 'docks_menu'): 
            mw.docks_menu.clear() # Clear and repopulate
