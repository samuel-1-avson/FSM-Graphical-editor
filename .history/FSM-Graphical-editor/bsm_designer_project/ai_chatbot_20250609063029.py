...
class AIChatUIManager(QObject):
    ...
    def create_dock_widget_contents(self) -> QWidget:
        ...
        # Ensure it can process HTML for links and display rich text
        self.ai_chat_display.setAcceptRichText(True) 
        # Key flags for link interaction:
        # Qt.TextBrowserInteraction is a good umbrella flag.
        # It includes Qt.LinksAccessibleByMouse, Qt.TextSelectableByMouse, etc.
        self.ai_chat_display.setTextInteractionFlags(Qt.TextBrowserInteraction)
        # self.ai_chat_display.setOpenLinks(False) # This line caused the AttributeError, not needed if we handle anchorClicked
