...
class ActionHandler(QObject):
    ...
    def connect_actions(self):
        ...
        # Snap actions are connected directly to settings manager in MainWindow's _apply_initial_settings
        # and their toggled signals are connected to the scene's properties directly or via settings manager.
        ...
        # Snap settings are handled via settings_manager in MainWindow when actions are toggled
        # This ensures persistence and consistent state.
        # self.mw.snap_to_objects_action.triggered.connect(lambda checked: self.mw.settings_manager.set("view_snap_to_objects", checked))
        # self.mw.snap_to_grid_action.triggered.connect(lambda checked: self.mw.settings_manager.set("view_snap_to_grid", checked))
        # self.mw.show_snap_guidelines_action.triggered.connect(lambda checked: self.mw.settings_manager.set("view_show_snap_guidelines", checked))
