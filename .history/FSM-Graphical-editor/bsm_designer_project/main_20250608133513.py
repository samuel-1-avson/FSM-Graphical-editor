...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui_manager = UIManager(self)       # UIManager created
        ...
        # Instantiate AIChatUIManager AFTER actions are created by UIManager.setup_ui()
        # self.ai_chat_ui_manager = AIChatUIManager(self) # MOVED
        ...
        self.ui_manager.setup_ui() # <<<<< Actions are created here
        
        # Instantiate AIChatUIManager NOW
        self.ai_chat_ui_manager = AIChatUIManager(self) # <<<<< MOVED HERE
