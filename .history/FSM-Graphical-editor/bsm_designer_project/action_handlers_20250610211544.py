...
class ActionHandler(QObject):
    ...
    def connect_actions(self):
        ...
        self.mw.export_python_fsm_action.triggered.connect(self.on_export_python_fsm) # Added for Python export
    ...
    def on_open_file(self):
        ...
        if file_path:
            if self.mw._load_from_path(file_path):
                ...
                if hasattr(self.mw, 'main_op_status_label'): self.mw.main_op_status_label.setText(f"Opened: {os.path.basename(file_path)}")
