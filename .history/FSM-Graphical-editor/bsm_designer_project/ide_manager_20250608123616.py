...
from PyQt5.QtCore import QObject, pyqtSlot, QSize, QTime, QDir, Qt, pyqtSignal # Added pyqtSignal
from PyQt5.QtGui import QIcon, QColor

from code_editor import CodeEditor
from utils import get_standard_icon
from config import ( # Added COLOR_BORDER_DARK here
...
class IDEManager(QObject):
    ide_dirty_state_changed = pyqtSignal(bool)    # Corrected
    ide_file_path_changed = pyqtSignal(str)      # Corrected
    ide_language_combo_changed = pyqtSignal(str) # Corrected
    ...
    def _setup_ide_dock_widget_content(self):
        ...
        ide_main_layout.setContentsMargins(0,0,0,0) # Remove margins for tighter fit
        ide_main_layout.setSpacing(0) # Remove spacing between toolbar and editor

        ide_toolbar = QToolBar("IDE Tools")
        ide_toolbar.setIconSize(QSize(18,18)) # Smaller icons
        ...
        lang_label = QLabel(" Lang:") # Shortened label
        ...
        ide_language_combo_layout.setContentsMargins(0,0,2,0) # Minimal margins for combo box
        ...
        # Ensure editor border is part of its own style, not layout spacing
        ...
        self.ide_output_console.setFixedHeight(120) # Slightly reduced height
        # Ensure console border is part of its own style
