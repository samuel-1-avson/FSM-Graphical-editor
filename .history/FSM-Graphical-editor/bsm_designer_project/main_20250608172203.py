...
import sys
import os
# NO sys.path modification block needed here if run as a module
...
if __name__ == '__main__':
    # This standard __main__ block will be used when running with `python -m ...`
    # The sys.path hack at the top is only for direct `python bsm_designer_project/main.py` execution.
    main_entry_point()