...
class MainWindow(QMainWindow):
    ...
    def _update_properties_dock(self): # Called by scene selectionChanged
        # This logic is quite tied to MainWindow's structure and UIManager's created elements.
        # For now, it can stay here. If it grows very complex, it could be moved to UIManager.
        selected_items = self.scene.selectedItems()
        
        # Assuming UIManager has created these attributes on MainWindow (self)
