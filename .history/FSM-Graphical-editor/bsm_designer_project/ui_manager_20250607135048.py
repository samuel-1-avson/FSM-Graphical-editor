...
from PyQt5.QtCore import Qt, QSize, QDir, QObject # Added QObject
...
class UIManager(QObject): 
    ...
    def _create_toolbars(self):
        ...
        file_toolbar = mw.addToolBar("File"); file_toolbar.setObjectName("FileToolBar"); file_toolbar.setIconSize(icon_size); file_toolbar.setToolButtonStyle(tb_style); file_toolbar.addAction(mw.new_action); file_toolbar.addAction(mw.open_action); file_toolbar.addAction(mw.save_action)
        edit_toolbar = mw.addToolBar("Edit"); edit_toolbar.setObjectName("EditToolBar"); edit_toolbar.setIconSize(icon_size); edit_toolbar.setToolButtonStyle(tb_style); edit_toolbar.addAction(mw.undo_action); edit_toolbar.addAction(mw.redo_action); edit_toolbar.addSeparator(); edit_toolbar.addAction(mw.delete_action); edit_toolbar.addAction(mw.find_item_action)
        tools_tb = mw.addToolBar("Interaction Tools"); tools_tb.setObjectName("ToolsToolBar"); tools_tb.setIconSize(icon_size); tools_tb.setToolButtonStyle(tb_style); tools_tb.addAction(mw.select_mode_action); tools_tb.addAction(mw.add_state_mode_action); tools_tb.addAction(mw.add_transition_mode_action); tools_tb.addAction(mw.add_comment_mode_action)
        
        code_gen_export_toolbar = mw.addToolBar("Code Generation & Export")
        code_gen_export_toolbar.setObjectName("CodeGenExportToolBar"); code_gen_export_toolbar.setIconSize(icon_size); code_gen_export_toolbar.setToolButtonStyle(tb_style)
        code_gen_export_toolbar.addAction(mw.export_simulink_action); code_gen_export_toolbar.addAction(mw.generate_matlab_code_action); code_gen_export_toolbar.addAction(mw.generate_c_code_action)
        code_gen_export_toolbar.addSeparator()
        code_gen_export_toolbar.addAction(mw.export_plantuml_action)
        code_gen_export_toolbar.addAction(mw.export_mermaid_action)

        
        sim_toolbar = mw.addToolBar("Simulation Tools"); sim_toolbar.setObjectName("SimulationToolBar"); sim_toolbar.setIconSize(icon_size); sim_toolbar.setToolButtonStyle(tb_style)
        sim_toolbar.addAction(mw.start_py_sim_action); sim_toolbar.addAction(mw.stop_py_sim_action); sim_toolbar.addAction(mw.reset_py_sim_action); sim_toolbar.addSeparator(); sim_toolbar.addAction(mw.run_simulation_action)
        
        view_toolbar = mw.addToolBar("View Tools"); view_toolbar.setObjectName("ViewToolBar"); view_toolbar.setIconSize(icon_size); view_toolbar.setToolButtonStyle(tb_style)
        view_toolbar.addAction(mw.zoom_in_action); view_toolbar.addAction(mw.zoom_out_action); view_toolbar.addAction(mw.reset_zoom_action); view_toolbar.addSeparator(); view_toolbar.addAction(mw.zoom_to_selection_action); view_toolbar.addAction(mw.fit_diagram_action)
        
        align_toolbar = mw.addToolBar("Alignment & Distribution"); align_toolbar.setObjectName("AlignDistributeToolBar"); align_toolbar.setIconSize(icon_size); align_toolbar.setToolButtonStyle(tb_style)
        align_toolbar.addAction(mw.align_left_action); align_toolbar.addAction(mw.align_center_h_action); align_toolbar.addAction(mw.align_right_action); align_toolbar.addSeparator(); align_toolbar.addAction(mw.align_top_action); align_toolbar.addAction(mw.align_middle_v_action); align_toolbar.addAction(mw.align_bottom_action); align_toolbar.addSeparator(); align_toolbar.addAction(mw.distribute_h_action); align_toolbar.addAction(mw.distribute_v_action)
        logger.debug("UIManager: Toolbars created.")
    ...
    def populate_dynamic_docks(self):
        ...
        if mw.ide_manager and hasattr(mw, 'ide_dock') and mw.ide_dock:
            # Content for ide_dock is set up by IDEManager itself in its _setup_ide_dock_widget_content
            pass
        else:
            logger.error("UIManager: Could not populate IDE Dock: IDEManager or ide_dock missing.")

        # Tabify docks as desired
        docks_to_tabify = [
            (mw.properties_dock, mw.ai_chatbot_dock),
            (mw.ai_chatbot_dock, mw.py_sim_dock),
            (mw.py_sim_dock, getattr(mw, 'ide_dock', None)), # Use getattr for ide_dock as it might not always exist
