...
class StateMachinePoweredSimulator:
    ...
    def _create_dynamic_callback(self, code_string, callback_type="action", original_name="dynamic_callback"):
        ...
        def dynamic_callback_wrapper(*args, **kwargs_from_sm_call):
            ...
            # FIX: Use a copy of SAFE_BUILTINS for globals, and ensure locals don't override __builtins__
            ...
            try:
                if callback_type == "action":
                    exec(code_string, exec_globals, exec_eval_locals_dict) # FIX: Use exec_globals
                    ...
                    result = eval(code_string, exec_globals, exec_eval_locals_dict) # FIX: Use exec_globals
    ...
    #     self.breakpoints["transitions"].add
