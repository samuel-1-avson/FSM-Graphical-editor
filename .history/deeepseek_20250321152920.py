...
class Transition(QGraphicsPolygonItem):
    ...
    def update_path(self):
        path = QPolygonF()
        start_point = self.start_state.pos() + QPointF(60, 40)  # Fixed: Removed extra parenthesis
        end_point = self.end_state.pos() + QPointF(60, 40)  # Fixed: Removed extra parenthesis
