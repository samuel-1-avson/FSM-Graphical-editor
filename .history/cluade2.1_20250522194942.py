...
def get_standard_icon(style_enum, alt_text=""):
    ...
    if not hasattr(QStyle, style_enum):
        return QIcon()
    return QApplication.style().standardIcon(getattr(QStyle, style_enum))

# Then in StatePropertiesDialog._create_insert_snippet_button:
