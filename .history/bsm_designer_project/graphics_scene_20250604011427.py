...
class DiagramScene(QGraphicsScene):
    ...
    def get_item_by_uuid(self, uuid_str: str) -> QGraphicsItem | None: # <--- NEW METHOD
        if not uuid_str:
            return None
