...
from config import (APP_FONT_SIZE_SMALL, COLOR_ACCENT_PRIMARY, COLOR_TEXT_SECONDARY, COLOR_TEXT_PRIMARY,
                    ...
                    COLOR_BACKGROUND_MEDIUM, COLOR_BORDER_LIGHT, COLOR_ACCENT_SECONDARY) # Added COLOR_ACCENT_SECONDARY
...
class PySimulationUIManager(QObject):
    ...
    def __init__(self, main_window, parent=None):
        ...
        self._py_sim_currently_highlighted_transition: GraphicsTransitionItem | None = None # <<<< ADDED
