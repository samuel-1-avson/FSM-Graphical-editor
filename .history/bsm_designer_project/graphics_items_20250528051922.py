...
class GraphicsStateItem(QGraphicsRectItem):
    ...
    def __init__(self, x, y, w, h, text, is_initial=False, is_final=False,
        ...
        self.action_language = action_language # Store action language
    ...
    def set_properties(self, name, is_initial, is_final, color_hex=None,
                       action_language=DEFAULT_EXECUTION_ENV, # Added
...
class GraphicsTransitionItem(QGraphicsPathItem):
    ...
    def __init__(self, start_item, end_item, event_str="", condition_str="", action_str="",
                 color=None, description="", action_language=DEFAULT_EXECUTION_ENV): # Added action_language
        super().__init__()
    ...
    def set_properties(self, event_str="", condition_str="", action_str="",
                       color_hex=None, description="", offset=None, action_language=DEFAULT_EXECUTION_ENV): # Added action_language
        changed = False
        ...
        if offset is not None or (changed and (self.control_point_offset.x() !=0 or self.control_point_offset.y() != 0)) : # Update path if offset changed or if other props changed and it's curved
            self.update_path()
