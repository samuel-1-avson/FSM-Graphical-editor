...
class GraphicsStateItem(QObject, QGraphicsRectItem):
    ...
    def __init__(self, x, y, w, h, text, is_initial=False, is_final=False,
        ...
        # Explicitly initialize QObject, optionally with its own parent
        QObject.__init__(self, q_object_parent)
        # Explicitly initialize QGraphicsRectItem with its specific arguments and graphics parent
        ...
        QGraphicsRectItem.__init__(self, rect, parent_item)
...
class GraphicsCommentItem(QGraphicsTextItem): # QGraphicsTextItem inherits QGraphicsObject which inherits QObject
    ...
    def __init__(self, x, y, text="Comment", parent_item=None):
        super().__init__(parent_item) # Call QGraphicsTextItem's constructor
