...
COLOR_ACCENT_PRIMARY_LIGHT = "#B3E5FC" # Material Light Blue 100 <--- ADDED THIS LINE
...
STYLE_SHEET_GLOBAL = f"""
    ...
    # bsm_designer_project/config.py
    # ... inside STYLE_SHEET_GLOBAL string ...
    QComboBox::down-arrow {{
     image: url(:/icons/arrow_down.png); /* Note the :/ prefix */
     width: 12px; height:12px;
    }}
    QCheckBox::indicator:checked {{
    border: 1px solid {QColor(COLOR_ACCENT_PRIMARY).darker(120).name()};
    border-radius: 3px;
    background-color: {COLOR_ACCENT_PRIMARY};
    image: url(:/icons/check.png); /* Note the :/ prefix */
    }}
