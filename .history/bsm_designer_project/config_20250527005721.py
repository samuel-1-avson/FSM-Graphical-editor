...
MECHATRONICS_COMMON_ACTIONS = {
    "Activate Motor": "activate_motor()",
    "Deactivate Motor": "deactivate_motor()",
    "Set LED On": "set_led(True)",
    "Set LED Off": "set_led(False)"
}

MECHATRONICS_COMMON_EVENTS = {
    "Button Pressed": "button_pressed",
    "Sensor Triggered": "sensor_triggered"
}

MECHATRONICS_COMMON_CONDITIONS = {
    "If Sensor Active": "sensor_is_active()",
    "If Motor Running": "motor_is_running()"
}
...
STYLE_SHEET_GLOBAL = f"""
    ...
    QTextEdit#LogOutputWidget, QTextEdit#PySimActionLog, QTextEdit#AIChatDisplay, QPlainTextEdit#ActionCodeEditor {{
