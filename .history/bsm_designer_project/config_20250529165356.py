...
STYLE_SHEET_GLOBAL = f"""
    ...
    QLineEdit:focus, QTextEdit:focus, QPlainTextEdit:focus, QSpinBox:focus, QComboBox:focus {{
        ...
        box-shadow: 0 0 3px {COLOR_ACCENT_PRIMARY_LIGHT}; /* Subtle glow, may not work on all platforms */
    }}
    ...
    QDockWidget#PySimDock QTableWidget {{
     ...
     QDockWidget#PySimDock QTableWidget QHeaderView::section /* Be more specific for table headers */
     {{
        background-color: {COLOR_BACKGROUND_MEDIUM};
        padding: 6px;
        border: 1px solid {COLOR_BORDER_LIGHT};
