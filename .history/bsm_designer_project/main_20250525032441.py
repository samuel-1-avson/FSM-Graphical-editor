...
# Add this class definition before the MainWindow class
class DraggableToolButton(QPushButton):
    """Custom button that supports drag operations for tool items"""
    
    def __init__(self, text: str, mime_type: str, drag_data: str, parent=None):
    ...
    def mouseMoveEvent(self, event: QMouseEvent):
        ...
        drag = QDrag(self)
        mime_data = QMimeData()
        mime_data.setData(self.mime_type, self.drag_data.encode())
        drag.setMimeData(mime_data)

        # Create a pixmap for drag feedback
        button_pixmap = self.grab()
        drag.setPixmap(button_pixmap)
    ...
    def _monitor_resources(self):
        ...
        while self._monitoring:
            try:
                ...
                self.resourceUpdate.emit(cpu_percent, ram_percent, gpu_util, self._gpu_name_cache)
