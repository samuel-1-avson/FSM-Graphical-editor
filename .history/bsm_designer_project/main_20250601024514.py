...
from config import (
    ...
    FSM_TEMPLATES_BUILTIN, COLOR_ITEM_STATE_DEFAULT_BORDER # Ensured this is imported
)
...
class MainWindow(QMainWindow):
    ...
    def _create_actions(self):
        ...
        self.find_item_action = QAction(get_standard_icon(QStyle.SP_FileDialogContentsView, "Find"), "&Find Item...", self, shortcut=QKeySequence.Find, statusTip="Find an FSM element by text", triggered=self.on_show_find_item_dialog) # Modified text
    ...
    def _create_menus(self):
        ...
        edit_menu.addSeparator()
        edit_menu.addAction(self.find_item_action) # Modified text
        edit_menu.addSeparator()
