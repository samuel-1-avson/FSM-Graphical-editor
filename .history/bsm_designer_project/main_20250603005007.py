...
from config import (
    ...
    COLOR_ACCENT_PRIMARY, COLOR_ACCENT_PRIMARY_LIGHT, COLOR_BACKGROUND_APP, COLOR_BACKGROUND_DIALOG, # Added COLOR_BACKGROUND_DIALOG
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # --- Properties Dock Direct Edit Attributes ---
        self._dock_property_editors = {} 
        self._current_edited_item_in_dock = None
        # --- End Properties Dock Attributes ---
    ...
    def _handle_py_sim_global_ui_enable_by_manager(self, enable: bool):
        ...
        if hasattr(self, 'properties_edit_dialog_button'): # Updated from properties_edit_button
        ...
        if hasattr(self, 'properties_editor_layout'):
            while self.properties_editor_layout.count():
                ...
                if child_layout_item:
                    ...
                    # QFormLayout rows can also have labels not part of a widget
                    elif child_layout_item.label():
