...
class MainWindow(QMainWindow):
    ...
    def _update_ide_related_actions(self):
        ...
        if self.ide_generate_code_action:
             ...
             self.ide_generate_code_action.setEnabled(can_ide_generate_code)
             self.ide_generate_code_action.setToolTip("Generate code snippet using AI" if can_ide_generate_code else "Requires active IDE tab, Internet & API Key")
