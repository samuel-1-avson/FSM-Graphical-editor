...
from PyQt5.QtGui import QColor, QPainter, QTextFormat, QFont, QSyntaxHighlighter, QTextCharFormat, QFontMetrics, QPalette
...
class CodeEditor(QPlainTextEdit):
    ...
    def set_language(self, language: str):
        ...
        if self.current_highlighter: 
            ...
            cursor.select(QTextEdit.SelectAll) 
            default_format = QTextCharFormat() 
            # If your QPlainTextEdit#ActionCodeEditor has a specific foreground, apply it here
            # For example, if your dark theme sets #CFD8DC as foreground:
            default_format.setForeground(QColor("#CFD8DC")) # Example, adjust if needed
            # If you have a general QPlainTextEdit style for text color, palette().color(QPalette.Text) might work
...
--- END OF FILE bsm_designer_project/code_editor.py ---