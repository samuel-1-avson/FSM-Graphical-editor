...
class ResourceMonitorWorker(QObject):
    ...
    WORKER_LOOP_CHECK_INTERVAL_MS = 200 
    ...
    def _monitor_resources(self):
        ...
        while not self._stop_requested: 
            ...
            # Use QThread.msleep for a short, interruptible pause.
            # The primary check is self._stop_requested at the start of the outer loop.
            # This sleep just prevents the loop from busy-waiting if data_collection_interval is large.
            if not self._stop_requested:
    ...
    def closeEvent(self, event: QCloseEvent):
        ...
        if self.resource_monitor_thread and self.resource_monitor_thread.isRunning():
            ...
            if self.resource_monitor_worker:
                ...
                self.resource_monitor_worker.stop_monitoring() # Direct call is fine, will set event
                logger.debug("MW_CLOSE: stop_monitoring called on resource worker.")
        ...
        if worker_ref_for_nvml_shutdown: 
            ...
            logger.info("MW_CLOSE: Shutting down NVML via direct worker attribute (thread might not have been running).")
