...
class MainWindow(QMainWindow):
    ...
    def _create_docks(self): # IDE Dock setup now delegated
        ...
        for btn in [self.toolbox_select_button, self.toolbox_add_state_button, self.toolbox_transition_button, self.toolbox_add_comment_button]:
            btn.setToolButtonStyle(Qt.ToolButtonIconOnly); btn.setIconSize(QSize(20,20)); mode_layout.addWidget(btn)
    ...
    def _create_toolbars(self):
        ...
        tools_tb.setToolButtonStyle(Qt.ToolButtonIconOnly) # Changed for better clarity
