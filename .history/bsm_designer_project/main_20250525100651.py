...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Basic instance variables first
        ...
        # Create scene and connect its signals
        ...
        # Create actions BEFORE managers that need them
        ...
        # Initialize managers AFTER actions are created
