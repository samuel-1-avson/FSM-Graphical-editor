...
STYLE_SHEET_GLOBAL = f"""
    ...
    QPushButton#DraggableToolButton {{
        ...
        padding: 8px; /* Adjusted: let icon and text flow, internal spacing helps */
        /* padding-left: 30px; /* Removed fixed padding, relying on natural flow or future programmatic layout */
        text-align: left; 
        font-weight: 500;
        min-height: 38px; /* Align with ToolButtons in same dock */
    }}
