...
class AIChatUIManager(QObject):
    ...
    def update_status_display(self, status_text: str):
        ...
        accent_secondary_color = COLOR_ACCENT_SECONDARY # It's already a string
        if isinstance(COLOR_ACCENT_SECONDARY, QColor): # Safety check if it were a QColor
        ...
        elif is_thinking: self.ai_chat_status_label.setStyleSheet(f"font-size: 8pt; color: {accent_secondary_color};")
