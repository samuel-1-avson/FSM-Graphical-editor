...
class MainWindow(QMainWindow):
    ...
    def _add_fsm_data_to_scene(self, fsm_data: dict, clear_current_diagram: bool = False):
        ...
        for i, state_data in enumerate(fsm_data.get('states', [])):
            ...
            props = {
                'x': pos_x, 'y': pos_y, 'width': item_width, 'height': item_height, # HERE are width and height
                'name': name,
            ...
            state_item = GraphicsStateItem(**props) # Use dictionary unpacking # Use dictionary unpacking
