        ...
        try:
            ...
            if "MATLAB_SCRIPT_SUCCESS:" in stdout_str:
                ...
                if stderr_str and extracted_error_detail not in stderr_str:
                    # Check if stderr_str provides genuinely new information
                    # or if it's mostly redundant with what's already in extracted_error_detail
                    # For now, assume it's useful context if present and different.
                ...
                stdout_context_for_failure = "\n".join(stdout_context_lines[:10]).strip()
