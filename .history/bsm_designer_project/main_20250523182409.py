...
from ai_chatbot import AIChatbotManager, ChatbotState
...
from fsm_simulator import EnhancedFSMSimulator as FSMSimulator, FSMError, LogEntry, LogLevel
...
class MainWindow(QMainWindow):
    ...
    def _update_ai_chat_status(self, status: str, details: str = ""):
        ...
        is_auth_error = "AUTH_ERROR" in details or "Invalid API key" in details or \
                        (self.ai_chatbot_manager.get_state() == ChatbotState.ERROR and "API_KEY_ERROR" in details)
