...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle(f"{APP_NAME} - Untitled [*]") # Initial title with placeholder
        ...
        self._update_window_title() # Call after all UI elements affecting title are potentially set
        self.on_new_file(silent=True) # This will also call _update_window_title
    ...
    def init_ui(self):
        ...
        # WindowIcon is set in _create_central_widget as it might depend on style being available
        self._create_central_widget() # self.view is created here
        self.setWindowIcon(get_standard_icon(QStyle.SP_DesktopIcon, "BSM")) # Set after view potentially
    ...
    def _create_actions(self):
        ...
        self.distribute_h_action = QAction(get_standard_icon(QStyle.SP_ToolBar 배열SortHorizontal if hasattr(QStyle, 'SP_ToolBar 배열SortHorizontal') else QStyle.SP_ArrowLeft, "DstH"), "Distribute Horizontally", self, statusTip="Distribute selected items horizontally", triggered=lambda: self.on_distribute_items("horizontal"))
        self.distribute_v_action = QAction(get_standard_icon(QStyle.SP_ToolBar 배열SortVertical if hasattr(QStyle, 'SP_ToolBar 배열SortVertical') else QStyle.SP_ArrowUp, "DstV"), "Distribute Vertically", self, statusTip="Distribute selected items vertically", triggered=lambda: self.on_distribute_items("vertical"))
    ...
    def _create_menus(self):
        ...
        # Add Show Dynamic Snap Guidelines Toggle Action
        ...
        if hasattr(self, 'scene') and hasattr(self.scene, '_show_dynamic_snap_guidelines'):
            ...
            self.show_snap_guidelines_action.setChecked(True) # Default if scene not ready
    ...
    def _create_docks(self): # Ensure View Menu actions for docks are added after view_menu is created
        self.setDockOptions(QMainWindow.AnimatedDocks | QMainWindow.AllowTabbedDocks | QMainWindow.AllowNestedDocks)

        self.tools_dock = QDockWidget("Elements & Modes", self) 
        self.tools_dock.setObjectName("ToolsDock")
        # ... (rest of tools_dock setup as before) ...
        ...
        # ... (rest of properties_dock setup as before) ...
        ...
        # ... (rest of log_dock setup as before) ...
        ...
        # ... (rest of py_sim_dock setup as before) ...
        ...
        # ... (rest of ai_chatbot_dock setup as before) ...
        self.addDockWidget(Qt.RightDockWidgetArea, self.ai_chatbot_dock)

        self._setup_ide_dock_widget() 

        # Add dock toggle actions to View menu *after* all docks are created
        if hasattr(self, 'view_menu'):
            ...
            if hasattr(self, 'ide_dock'): # ide_dock is created in _setup_ide_dock_widget
    ...
    def _setup_ide_dock_widget(self):
        ...
        # Note: View menu action for ide_dock is added in _create_docks after this method is called
        # self.view_menu.addAction(self.ide_dock.toggleViewAction()) # This would be more direct if view_menu is guaranteed
    ...
    def on_toggle_show_snap_guidelines(self, checked):
        if hasattr(self.scene, '_show_dynamic_snap_guidelines'):
            ...
            if not checked: # If disabling, clear any existing guidelines
