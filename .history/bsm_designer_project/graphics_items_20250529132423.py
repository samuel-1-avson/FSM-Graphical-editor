...
class GraphicsStateItem(QObject, QGraphicsRectItem):
    ...
    def __init__(self, x, y, w, h, text, is_initial=False, is_final=False,
        ...
        # Call QObject constructor directly
        QObject.__init__(self, q_object_parent)
        # Call QGraphicsRectItem constructor directly
    ...
    def itemChange(self, change, value):
        ...
        return QGraphicsRectItem.itemChange(self, change, value) # Use specific base
...
class GraphicsTransitionItem(QObject, QGraphicsPathItem):
    ...
    def __init__(self, start_item, end_item, event_str="", condition_str="", action_str="",
                 ...
                 parent_item=None, q_object_parent=None):
        QObject.__init__(self, q_object_parent)
        QGraphicsPathItem.__init__(self, parent_item) # No path argument here initially
        ...
        self.setZValue(-1)
        self.setAcceptHoverEvents(True)
        self.update_path() # Calculate and set path

    def itemChange(self, change, value):
        return QGraphicsPathItem.itemChange(self, change, value) # Use specific base
