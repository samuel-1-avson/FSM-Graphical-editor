...
class AppearanceSettingsTab(QWidget):
    ...
    def apply_specific_settings(self, data):
        ...
        if current_app_font_size != new_font_size:
            ...
            QApplication.instance().setFont(font) # This can be expensive
            self.main_window.setStyleSheet("") # Trigger re-evaluation
            self.main_window.setStyleSheet(self.main_window.global_style_sheet_template) # This can be very expensive # Local import
