    ...
    def set_language(self, language: str):
        ...
        if self.document():
            ...
            if self.current_highlighter:
                ...
                cursor.select(QTextEdit. पूरेDocument) # QTextEdit.SelectAll equivalent for QPlainTextEdit
                ...
                self.document().markContentsDirty(0, self.document().toPlainText().length())
