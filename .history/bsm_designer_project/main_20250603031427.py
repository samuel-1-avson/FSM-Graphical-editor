...
class MainWindow(QMainWindow):
    ...
    def _connect_signals(self):
        ...
        # ViewManager now connects to self.view.zoomChanged and relevant scene.selectionChanged
    ...
    def init_ui(self):
        ...
        # ViewManager needs actions to be created before it can connect to them
    ...
    def closeEvent(self, event: QCloseEvent):
        ...
        if self.file_op_manager and not self.file_op_manager._prompt_save_if_dirty():
            event.ignore(); return
        # ... (rest of closeEvent logic for PySim, Internet, AI, Resource Monitor) ...
