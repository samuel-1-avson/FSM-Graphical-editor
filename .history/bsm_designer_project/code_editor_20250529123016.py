    ...
    def set_language(self, language: str):
        ...
        if self.current_highlighter:
            ...
            while block.isValid():
                ...
                if palette_base_color == COLOR_EDITOR_DARK_BACKGROUND: 
                    default_text_color = QColor("#CFD8DC") 
                else: 
                    default_text_color = QColor(COLOR_TEXT_PRIMARY) 
...
class CSyntaxHighlighter(QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        # Added -> operator
        operatorFormat = QTextCharFormat() # Assuming a color for operators
        operatorFormat.setForeground(QColor("#B4B4B4")) # A light grey for operators
