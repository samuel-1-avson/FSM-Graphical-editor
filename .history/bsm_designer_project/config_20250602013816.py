...
STYLE_SHEET_GLOBAL = f"""
    ...
    /* Duplicate selector block removed here for cleanliness, original intent was likely for all status labels.
       If specific individual styling is needed later, it can be added.
       The previous block with QMainWindow QLabel[objectName$="StatusLabel"] covers most cases.
    */
    ...
    #PropertiesDock QLabel#PropertiesLabel {{ 
        ...
        border: 1px solid {COLOR_BORDER_LIGHT}; border-radius: 4px; /* line-height: 1.5; Removed potentially problematic property */
        font-size: {APP_FONT_SIZE_STANDARD}; 
    }}
