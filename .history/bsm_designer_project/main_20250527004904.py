...
from dialogs import (MatlabSettingsDialog) # FindReplaceDialog will be added here later
from config import (
...
class MainWindow(QMainWindow):
    ...
    def _update_ide_related_actions(self):
        ...
        if self.ide_analyze_action:
            ...
            elif not self.ai_chatbot_manager or not self.ai_chatbot_manager.api_key:
    ...
    def on_ide_find(self):
        ...
        from dialogs import FindReplaceDialog # Lazy import
        ...
        if not hasattr(self, '_find_replace_dialog_instance') or not self._find_replace_dialog_instance.isVisible():
    ...
    def on_ide_replace(self):
        ...
        if not hasattr(self, '_find_replace_dialog_instance') or not self._find_replace_dialog_instance.isVisible():
            ...
            self._find_replace_dialog_instance.prepare_for_replace()
