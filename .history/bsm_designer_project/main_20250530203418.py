...
try:
    ...
    print("DEBUG: resources_rc.py imported successfully.") # Add this for debug
except ImportError:
    RESOURCES_AVAILABLE = False
    # logger might not be configured yet if this is very early
    print("WARNING: resources_rc.py not found. Icons and bundled files might be missing. Run pyrcc5.")
try:
    import pynvml
...
class MainWindow(QMainWindow):
    ...
    def _create_actions(self):
        ...
        self.distribute_h_action = QAction(
        get_standard_icon(QStyle.SP_ArrowLeft, "DstH"),
        "Distribute Horizontally",
        self,
        statusTip="Distribute selected items horizontally",
        triggered=lambda: self.on_distribute_items("horizontal")
        )
        self.distribute_v_action = QAction(
        get_standard_icon(QStyle.SP_ArrowUp, "DstV"),
        "Distribute Vertically",
        self,
        statusTip="Distribute selected items vertically",
        triggered=lambda: self.on_distribute_items("vertical")
        )
