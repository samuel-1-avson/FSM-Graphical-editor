...
class AIChatUIManager(QObject):
    def __init__(self, main_window, parent=None):
        ...
        # UI Elements for the AI Chatbot Dock
    ...
    def _connect_actions_to_manager_slots(self):
        # Connect MainWindow's AI-related actions to this manager's slots
    ...
    def create_dock_widget_contents(self) -> QWidget:
        ...
        self.update_status_display("Status: API Key required. Configure in Settings.") # Initial state
    ...
    def update_status_display(self, status_text: str):
        ...
        # Update MainWindow's global action for generating FSM
        if hasattr(self.mw, 'ask_ai_to_generate_fsm_action'):
    ...
    def handle_fsm_data_from_ai(self, fsm_data: dict, source_message: str):
        ...
        # Delegate to MainWindow's method for adding FSM data to the scene
    ...
    def on_openai_settings(self):
        ...
        key, ok = QInputDialog.getText(
            ...
            QLineEdit.PasswordEchoOnEdit, # Use PasswordEchoOnEdit
            current_key
        )
        if ok:
    ...
    def on_clear_ai_chat_history(self):
        if self.mw.ai_chatbot_manager:
            ...
            self.update_status_display("Status: Chat history cleared.") # Reflect in status
        else:
            self.handle_ai_error("AI Chatbot Manager not initialized.")