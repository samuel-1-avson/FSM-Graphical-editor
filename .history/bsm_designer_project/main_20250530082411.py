...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.scene.selectionChanged.connect(self._update_zoom_to_selection_action_enable_state) # Connect here
        ...
        self.init_ui() # This will create self.view
        ...
        self._update_zoom_to_selection_action_enable_state() # Initial check
    ...
    def init_ui(self):
        ...
        self._create_actions() # self.view is available after _create_central_widget for action connections
        self._create_menus()
    ...
    def _create_menus(self):
        ...
        self.view_menu = menu_bar.addMenu("&View") # Ensure view_menu is created
        ...
        # Dock Toggles will be added in _create_docks or later after view_menu is confirmed
        self.view_menu.addSeparator() 
    ...
    def _create_docks(self):
        ...
        self._setup_ide_dock_widget() # This will also add its toggle action to view_menu
    ...
    def _add_fsm_data_to_scene(self, fsm_data: dict, clear_current_diagram: bool = False, original_user_prompt: str = "AI Generated FSM"):
        ...
        elif not clear_current_diagram: # Still need to end macro if it was started
             self.undo_stack.endMacro()
