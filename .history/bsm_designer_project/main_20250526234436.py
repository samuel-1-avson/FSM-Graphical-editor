...
class MainWindow(QMainWindow):
    ...
    def _setup_ide_dock_widget(self):
        ...
        # self.ide_language_combo.currentIndexChanged.connect(self.on_ide_language_changed) # Connect later
        ...
        # self.tabifyDockWidget(self.py_sim_dock, self.ide_dock) # Tab with PySim dock - will be done in populate_dynamic_docks
    ...
    def _add_fsm_data_to_scene(self, fsm_data: dict, clear_current_diagram: bool = False, original_user_prompt: str = "AI Generated FSM"): 
        ...
        for trans_data in fsm_data.get('transitions', []): # Corrected: removed trailing ')'
