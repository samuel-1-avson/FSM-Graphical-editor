...
FSM_TEMPLATES_BUILTIN = {
    "debounce": """
        {
            "name": "Debounce Logic",
            "description": "A simple debounce pattern for an input signal. Assumes 'start_debounce_timer()' is defined by the user for the 'Waiting' state's entry action.", # Good description
    ...
    "blinker": """
        {
            "name": "Simple Blinker",
            "description": "Toggles between On and Off states. Assumes 'set_led_high/low' actions and timer events are handled.", # Good description
