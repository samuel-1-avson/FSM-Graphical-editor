...
class PySimulationUIManager(QObject):
    ...
    def create_dock_widget_contents(self) -> QWidget:
        ...
        # --- NEW: Continue Button for Breakpoints ---
        self.py_sim_continue_btn = QPushButton("Continue")
        self.py_sim_continue_btn.setIcon(get_standard_icon(QStyle.SP_MediaSkipForward, "Cont")) # Using SkipForward as "play next segment"
        ...
        self.py_sim_continue_btn.setEnabled(False) # Initially disabled
