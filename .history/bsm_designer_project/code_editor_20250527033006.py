--- START OF FILE bsm_designer_project/code_editor.py ---
...
class CodeEditor(QPlainTextEdit):
    ...
    def keyPressEvent(self, event: QKeyEvent):
        ...
        print(f"CodeEditor KeyPress: {event.key()}, Text: '{event.text()}', ReadOnly: {self.isReadOnly()}") # Check if event arrives and readonly status
        super().keyPressEvent(event) # Pass all events to the base class for now
        return # End of simplified version
