...
from PyQt5.QtGui import (
    ...
    QPalette, QTextCursor # Added QPalette and QTextCursor import
)
...
class CSyntaxHighlighter(QSyntaxHighlighter):
    ...
    def highlightBlock(self, text):
        ...
        while startIndex >= 0:
            endIndex = self.commentEndExpression.indexIn(text, startIndex + self.commentStartExpression.matchedLength()) # Start searching for end *after* start
            commentLength = 0
