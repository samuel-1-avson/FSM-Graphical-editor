...
from PyQt5.QtWidgets import (
    ...
    QHBoxLayout  # <--- ADD QHBoxLayout HERE
)
...
class IDEManager(QObject):
    ...
    def setup_ide_dock_widget(self):
        ...
        # This line caused the error because QHBoxLayout was not imported
        ...
        self.mw.addDockWidget(Qt.RightDockWidgetArea, self.ide_dock)
    ...
    # ... (rest of IDEManager methods remain the same)
    @pyqtSlot()
    ...
    def on_ide_new_file(self):
        if not self._prompt_ide_save_if_dirty():
            return
        # ...
        self.mw.update_window_title() # Use public method
        logger.info("IDE: New script created.")
    ...
    def on_ide_open_file(self):
        ...
        if file_path and self.ide_code_editor:
            try:
                ...
                if self.ide_language_combo:
                    # ...
                    pass # Language change will trigger title update
                else:
                    self.mw.update_window_title() # Update if combo not present
                # ...
            except Exception as e:
                # ...
                pass
    ...
    def on_ide_text_changed(self):
        if not self.ide_editor_is_dirty:
            ...
            self.update_ide_save_actions_enable_state()
            # Ensure this call uses the public method name
    ...
    def on_ide_language_changed(self, language_param: str):
        ...
        ai_ready = self.mw.ai_chatbot_manager is not None and \
                   ...
                   self.mw._internet_connected is True
