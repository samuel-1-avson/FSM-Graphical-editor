...
class MainWindow(QMainWindow):
    ...
    def _update_ide_related_actions(self):
        ...
        if self.ide_clear_console_action:
            self.ide_clear_console_action.setEnabled(self.ide_output_console is not None and bool(self.ide_output_console.toPlainText().strip()))
        if self.ide_save_output_action:
            self.ide_save_output_action.setEnabled(self.ide_output_console is not None and bool(self.ide_output_console.toPlainText().strip()))
    ...
    def on_ide_save_output(self):
        if not self.ide_output_console or not self.ide_output_console.toPlainText().strip():
        ...
        if file_path:
            self._save_text_to_file(file_path, self.ide_output_console.toPlainText())
