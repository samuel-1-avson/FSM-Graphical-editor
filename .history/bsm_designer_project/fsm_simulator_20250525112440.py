...
class StateMachinePoweredSimulator:
    ...
    def _master_on_enter_state(self, machine_self: StateMachine, target: State, **kwargs):
    ...
    def _master_on_exit_state(self, machine_self: StateMachine, source: State, **kwargs):
    ...
    def _sm_before_transition(self, machine_self: StateMachine, event: str, source: State, target: State, **kwargs):
    ...
    def _sm_after_transition(self, machine_self: StateMachine, event: str, source: State, target: State, **kwargs):
        event_data_obj = kwargs.get('event_data')
        triggered_event_name = event_data_obj.event if event_data_obj else event
    ...
    def step(self, event_name=None):
        ...
        try:
            ...
            elif not self.active_sub_simulator: # No explicit event and no active sub-machine to step
...
if __name__ == "__main__":
    ...
    try:
        ...
        halt_sim = None # Ensure it's defined for the finally-like log print
        try:
            ...
            if halt_sim and hasattr(halt_sim, 'get_last_executed_actions_log'): # Check if halt_sim was partially created
