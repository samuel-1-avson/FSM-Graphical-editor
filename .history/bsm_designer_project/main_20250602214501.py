...
current_dir = os.path.dirname(os.path.abspath(__file__)) # Directory of main.py (bsm_designer_project)
parent_dir = os.path.dirname(current_dir)               # Directory 'Project research'
if parent_dir not in sys.path:
    sys.path.insert(0, parent_dir)

# Now your imports should work, assuming 'Project research' is the top-level for your package imports
from bsm_designer_project.c_code_generator import generate_c_code_files
# bsm_designer_project/main.py
...
def on_generate_c_code(self):
    ...
    if output_dir:
        ...
        if ok and filename_base.strip():
            ...
            # Further sanitize filename_base if necessary
    ...
    def on_new_file(self, silent=False):
        ...
        self.scene.run_all_validations("NewFile")
        return True
